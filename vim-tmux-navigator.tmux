...
tmux bind-key -n C-m if-shell "$is_vim" "send-keys C-m" "select-pane -L"
tmux bind-key -n C-n if-shell "$is_vim" "send-keys C-n" "select-pane -D"
tmux bind-key -n C-e if-shell "$is_vim" "send-keys C-e" "select-pane -U"
tmux bind-key -n C-i if-shell "$is_vim" "send-keys C-i" "select-pane -R"
